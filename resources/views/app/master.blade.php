...
<head>
    ...
    <title>Administrator - {{ config('app.name', 'AlBahri-KKP') }}</title>
...
<body>
            ...
            <div class="brand-logo">
                <a href="{{ url('/home') }}">
                    ...
                    <span class="brand-title">
                        ...
                        <span class="text-white ml-2">ALBAHRI<b>-KKP</b></span>
                    </span>
                </a>
            </div>
        </div>
    ...
    <div class="footer">
        <div class="copyright">
            <p>Copyright &copy; Aplikasi Keuangan Masjid. by <a href="https://sopyanahmad87.blogspot.com" target="_blank">Kang Iyan</a> {{ date('Y') }}</p>
        </div>
    </div>
</div>
